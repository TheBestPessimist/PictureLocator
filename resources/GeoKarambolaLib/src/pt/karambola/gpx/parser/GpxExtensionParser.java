 ...
 * <p>Any custom parser must be added to {@link GpxParser} as an extension parser
 * before parsing a gpx file, or writing a {@link Gpx} to a file. This is done by
 * calling addExtensionParser() method of {@link GpxParser}
 * <p>{@link GpxParser} parseGPX method calls several methods from the registered
 ...
 * <br>
 * 
 * <p>{@link GpxParser} writeGPX method also calls several methods from the registered
