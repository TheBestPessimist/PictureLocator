...
import pt.karambola.commons.collections.Closure;
import pt.karambola.commons.collections.Transformer;
...
FunctorUtils
{
    ...
    static <T>
    Predicate<? super T>[]
    validate(final Collection<? extends Predicate<? super T>> predicates)
    {
        if (predicates == null)  throw new NullPointerException("The predicate collection must not be null");
        ...
        {
            if (predicate == null)  throw new NullPointerException( "The predicate collection must not contain a null predicate, index " + i + " was null");
            preds[i++] = predicate;
        }
     ...
     */
    static void
    validate(final Transformer<?, ?>... transformers)
    {
        if (transformers == null)
    ...
    coerce( final Transformer<? super I, ? extends O> transformer )
    {
